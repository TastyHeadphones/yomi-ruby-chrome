(() => {
  const LOCALES = {
    en: {
      ...
      popup_cannot_edit_while_running: "Cannot edit readings while annotation is running.",
      popup_kana_hidden: "Kana hidden.",
      popup_kana_shown: "Kana shown.",
      popup_kana_visibility_failed: "Kana visibility change failed.",
      popup_edit_readings: "Edit Readings",
      popup_exit_edit_mode: "Exit Edit Mode",
      popup_edit_mode_enabled: "Edit mode enabled on the page.",
      popup_edit_mode_disabled: "Edit mode turned off.",
      popup_edit_mode_failed: "Could not change edit mode.",
      ...
      options_hero_label: "Furigana",
      options_hero_title: "Page annotations with page-level correction support",
      options_interface_section_title: "Interface",
      options_interface_section_description: "Language changes apply immediately.",
      ...
      options_language_updated: "Language updated.",
      options_language_update_failed: "Could not update the language setting.",
      options_annotation_section_title: "Annotation",
      options_annotation_section_description: "Choose how furigana is generated and save those settings separately.",
      ...
      options_save_annotation_settings: "Save Annotation Settings",
      ...
      options_annotation_settings_saved: "Annotation settings saved.",
      ...
      options_feedback_title: "Feedback & Support",
      options_feedback_description: "Have questions, suggestions, or found a bug? You can contact the author directly to send feedback or report issues.",
      options_feedback_link_text: "Send Feedback via Facebook",
      options_author_label: "Author",
      ...
      content_exit_edit_mode: "Done",
      content_edit_mode_enabled: "Edit mode is on.",
      content_edit_mode_disabled: "Edit mode is off.",
      content_edit_mode_busy: "Finish the current annotation run before editing readings.",
      content_original_reading_label: "Original: {{reading}}",
      content_save_reading: "Save",
      content_reset_reading: "Reset",
      content_cancel_edit: "Cancel",
      content_edit_requires_reading: "Enter a reading before saving.",
      content_edit_save_failed: "Could not save the reading change.",
      content_reading_saved: "Reading saved for this page.",
      content_reading_reset: "Reading reset to the original result.",
    ...
    ja: {
      ...
      options_feedback_title: "フィードバックとサポート",
      options_feedback_description: "ご質問やご提案、バグ報告などがございましたら、制作者に直接連絡してフィードバックをお送りいただけます。",
      options_feedback_link_text: "Facebookでフィードバックを送信",
      options_author_label: "制作者",
    ...
    "zh-CN": {
      ...
      options_feedback_title: "反馈与支持",
      options_feedback_description: "有任何问题、建议或发现 Bug？您可以直接联系作者以发送反馈或报告问题。",
      options_feedback_link_text: "通过 Facebook 发送反馈",
      options_author_label: "作者",
    ...
    ko: {
      ...
      options_feedback_title: "피드백 및 지원",
      options_feedback_description: "질문, 제안이 있거나 버그를 발견하셨나요? 제작자에게 직접 문의하여 피드백을 보내거나 문제를 보고할 수 있습니다.",
      options_feedback_link_text: "Facebook을 통해 피드백 보내기",
      options_author_label: "제작자",
    ...
    th: {
      ...
      options_feedback_title: "คำติชมและสนับสนุน",
      options_feedback_description: "มีคำถาม ข้อเสนอแนะ หรือพบข้อผิดพลาด? คุณสามารถติดต่อผู้เขียนได้โดยตรงเพื่อส่งความคิดเห็นหรือรายงานปัญหา",
      options_feedback_link_text: "ส่งคำติชมผ่าน Facebook",
      options_author_label: "ผู้เขียน",
    ...
    vi: {
      ...
      options_feedback_title: "Phản hồi & Hỗ trợ",
      options_feedback_description: "Có câu hỏi, đề xuất hoặc phát hiện lỗi? Bạn có thể liên hệ trực tiếp với tác giả để gửi phản hồi hoặc báo cáo sự cố.",
      options_feedback_link_text: "Gửi phản hồi qua Facebook",
      options_author_label: "Tác giả",
    ...
    id: {
      ...
      options_feedback_title: "Umpan Balik & Dukungan",
      options_feedback_description: "Punya pertanyaan, saran, atau menemukan bug? Anda dapat langsung menghubungi penulis untuk mengirim umpan balik atau melaporkan masalah.",
      options_feedback_link_text: "Kirim Umpan Balik via Facebook",
      options_author_label: "Penulis",
