(() => {
  const LOCALES = {
    en: {
      ...
      options_description: "Enter your Yahoo! JAPAN Client ID. Offline mode can annotate with the local dictionary.",
    ...
    ja: {
      ...
      options_description: "Yahoo! JAPAN の Client ID を入力します。オフラインモードではローカル辞書で注釈できます。",
      options_client_id_label: "Yahoo Client ID",
    ...
    "zh-CN": {
      ...
      options_description: "请输入 Yahoo! JAPAN 的 Client ID。离线模式可使用本地词典进行注音。",
      options_client_id_label: "Yahoo Client ID",
    ...
    ko: {
      ...
      options_description: "Yahoo! JAPAN Client ID를 입력하세요. 오프라인 모드에서는 로컬 사전으로 주석할 수 있습니다.",
      options_client_id_label: "Yahoo Client ID",
    ...
    th: {
      ...
      options_description: "กรอก Yahoo! JAPAN Client ID ของคุณ โหมดออฟไลน์สามารถใส่คำอ่านด้วยพจนานุกรมภายในได้",
      options_client_id_label: "Yahoo Client ID",
    ...
    vi: {
      ...
      options_description: "Nhập Yahoo! JAPAN Client ID của bạn. Chế độ ngoại tuyến có thể chú thích bằng từ điển cục bộ.",
      options_client_id_label: "Yahoo Client ID",
    ...
    id: {
      ...
      options_description: "Masukkan Yahoo! JAPAN Client ID Anda. Mode offline bisa menganotasi dengan kamus lokal.",
      options_client_id_label: "Yahoo Client ID",
