(() => {
  const constants = {
    ...
    LOCAL_KEYS: {
      PAGE_OVERRIDE_PREFIX: "yomirubyPageOverride:"
    },
    SESSION_KEYS: {
    ...
    MESSAGE_TYPES: {
      ...
      GET_EDIT_MODE_STATE: "YOMIRUBY_GET_EDIT_MODE_STATE",
      TOGGLE_EDIT_MODE: "YOMIRUBY_TOGGLE_EDIT_MODE",
      ...
      GET_PAGE_OVERRIDES: "YOMIRUBY_GET_PAGE_OVERRIDES",
      SAVE_PAGE_OVERRIDE: "YOMIRUBY_SAVE_PAGE_OVERRIDE",
      DELETE_PAGE_OVERRIDE: "YOMIRUBY_DELETE_PAGE_OVERRIDE",
